-keep class com.fypmoney.model.** { *; }
-keepnames class okhttp3.internal.publicsuffix.PublicSuffixDatabase
-keep class com.fypmoney.database.entity.** { *; }
...
-keep class com.fypmoney.view.activity.AadhaarVerificationView
-keep class com.fypmoney.viewmodel.AadhaarVerificationViewModel
