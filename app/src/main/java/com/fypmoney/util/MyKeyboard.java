...
public class MyKeyboard extends LinearLayout implements View.OnClickListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // initialize buttons
        LayoutInflater.from(context).inflate(R.layout.mykeyboard, this, true);
        ...
        mButtonEnter = (Button) findViewById(R.id.btnVerify);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.iv_delete) {
            ...
            if (value==null){
                mButtonEnter.setBackgroundResource(R.drawable.button_skin);

            }else {
                mButtonEnter.setAnimation(AnimationUtils.loadAnimation(getContext(),R.anim.slide_out_left));
                mButtonEnter.setBackgroundResource(R.drawable.button_rectangle_skin);
