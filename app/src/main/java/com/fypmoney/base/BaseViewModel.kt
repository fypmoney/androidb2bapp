...
abstract class BaseViewModel(application: Application) : AndroidViewModel(application),
    ...
    override fun onError(purpose: String, errorResponseInfo: ErrorResponseInfo) {
        try {
            when {
                purpose != ApiConstant.API_SNC_CONTACTS || purpose != ApiConstant.API_FETCH_ALL_FEEDS || purpose != ApiConstant.API_GET_CUSTOMER_INFO ||purpose != ApiConstant.API_ADD_FAMILY_MEMBER -> {
            ...
            when {
                purpose != ApiConstant.API_SNC_CONTACTS||purpose != ApiConstant.API_ADD_FAMILY_MEMBER ->
