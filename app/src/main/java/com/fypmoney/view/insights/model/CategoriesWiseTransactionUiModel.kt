...
import com.fypmoney.util.AppConstants.CHANGED_DATE_TIME_FORMAT8
    ...
    companion object{
        fun mapAllTxnItemToCategoriesWiseTransactionUiModel(context: Context, allTxnItem: AllTxnItem):CategoriesWiseTransactionUiModel{
            return CategoriesWiseTransactionUiModel(
                ...
                categoryTxnTime = Utility.parseDateTimeWithPlusFiveThirty(allTxnItem.transactionDate,SERVER_DATE_TIME_FORMAT3,CHANGED_DATE_TIME_FORMAT8),
