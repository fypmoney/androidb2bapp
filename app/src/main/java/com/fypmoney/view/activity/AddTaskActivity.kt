...
class AddTaskActivity : BaseActivity<ActivityAddTaskBinding, AddTaskViewModel>() , DialogUtils.OnAlertDialogClickListener{
    ...
    fun AddTask() {
        try {
            ...
            val responseBodyCall = apiInterface.AddTask("web_app", "d37d9fef-0023-4386-bda6-405fefff24bb-1ee78233bfe5797f59587de811ba078cc74642fc8a104ebfa745d321d674275f",task )
