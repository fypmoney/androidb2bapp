...
import com.fypmoney.databinding.BottomWhoopsBinding
...
* */
class WhoopsBSFragment(
    private var taskEntity: TaskEntity?, private var onBottomSheetClickListener: OnWPBottomSheetClickListener
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(
            R.layout.bottom_whoops,
            container,
            false
        )
        dialog?.window?.setBackgroundDrawable(ColorDrawable(Color.TRANSPARENT))
        val bottomSheet = BottomSheetDialog(requireContext())
        val bindingSheet = DataBindingUtil.inflate<BottomWhoopsBinding>(
            layoutInflater,
            R.layout.bottom_whoops,
            null,
            false
    ...
    interface OnWPBottomSheetClickListener {
        fun OnWPBottomSheetClickListener()
