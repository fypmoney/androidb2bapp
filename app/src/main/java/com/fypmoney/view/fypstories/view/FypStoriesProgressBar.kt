...
internal class FypStoriesProgressBar @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet?,
    ...
    fun startProgress() {
        ...
        animation =
            PausableScaleAnimation(0.0f, 1.0f, 1.0f, 1.0f, Animation.ABSOLUTE, 0.0f, Animation.RELATIVE_TO_SELF, 0.0f)
