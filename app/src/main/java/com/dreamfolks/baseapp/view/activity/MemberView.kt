...
import com.dreamfolks.baseapp.databinding.ViewMemberBinding
import com.dreamfolks.baseapp.util.AppConstants
import com.dreamfolks.baseapp.util.Utility
import com.dreamfolks.baseapp.view.fragment.LeaveMemberBottomSheetFragment
import com.dreamfolks.baseapp.viewmodel.MemberViewModel
...
class MemberView : BaseActivity<ViewMemberBinding, MemberViewModel>(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setToolbarAndTitle(
            ...
            toolbarTitle = getString(R.string.members_heading),
